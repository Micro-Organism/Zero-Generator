...
import com.zero.generator.common.annotation.Log;
import com.zero.generator.common.enums.BusinessType;
import com.zero.generator.common.web.domain.AjaxResult;
import com.zero.generator.common.web.page.TableDataInfo;
import com.zero.generator.domain.CxSelect;
...
import com.zero.generator.util.PermissionUtils;
import com.zero.generator.common.annotation.RequiresPermissions;
import com.zero.generator.util.SqlUtil;
...
public class GeneratorController extends BaseController
{
    ...
    public AjaxResult importTableSave(String tables)
    {
        ...
        String operaName = "zero";//ConvertUtils.toStr(PermissionUtils.getPrincipalProperty("loginName"));
        genTableService.importGenTable(tableList, operaName);
...
//    @RequiresRoles("admin")
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"zero.generator.zip\"");
