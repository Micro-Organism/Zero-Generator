...
public class VelocityUtils
{
    ...
    public static void setSubVelocityContext(VelocityContext context, GenTable genTable)
    {
        ...
        String subTableFkClassName = ZeroStringUtils.toCamelCase(subTableFkName);
    ...
    public static String getTreecode(JSONObject paramsObj)
    {
        ...
        {
            return ZeroStringUtils.toCamelCase(paramsObj.getString(GenConstants.TREE_CODE));
        }
    ...
    public static String getTreeParentCode(JSONObject paramsObj)
    {
        if (paramsObj.containsKey(GenConstants.TREE_PARENT_CODE))
        {
            return ZeroStringUtils.toCamelCase(paramsObj.getString(GenConstants.TREE_PARENT_CODE));
        }
        return StringUtils.EMPTY;
    }
    ...
    public static String getTreeName(JSONObject paramsObj)
    {
        if (paramsObj.containsKey(GenConstants.TREE_NAME))
        {
            return ZeroStringUtils.toCamelCase(paramsObj.getString(GenConstants.TREE_NAME));
        }
        return StringUtils.EMPTY;
    }
